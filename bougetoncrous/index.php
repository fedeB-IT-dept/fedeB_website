...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" >
	...
	<head>
		<title>Bouge ta Fac en Bretagne Occidentale</title>
		...
		<script>
			(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),
 		 	m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)
  		 	...
  		 	ga('create', 'UA-45290554-1', 'fedeb.net');
  		 	ga('send', 'pageview');
		 </script>
	</head>
...
<script>(function(d, s, id)
{
  ...
  fjs.parentNode.insertBefore(js, fjs);
	...
	<body>
		...
		<header>
        <div id=top>
		<a href="index.php" title="Accueil"><img src="rep_img/logo2.jpg" width="100%" title="logo" alt="logo" id="logo"></a>
            	</div>
        </header>
		...
		<div id="social_top">
        	<ul>
            		<li><a href="https://www.facebook.com/fedeb.net" title="Facebook"><img src="rep_img/facebook.png" title="facebook" alt="facebook"/></a></li>
                	<li><a href="https://twitter.com/fedeb29" title="Twitter"><img src="rep_img/twitter.png" title="twitter" alt="twitter"/></a></li>
            </ul>
        </div>
		<div id="corps">
		...
		La plate-forme est administrée et éditée par <a href="https://www.facebook.com/alexandre.lorret">Alexandre Lorret</a> - <a href="mailto:contact@fedeb.net">contact@fedeb.net</a>
		    </p>
