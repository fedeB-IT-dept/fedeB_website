...
elseif ($_GET["security_code"] != "3y32l87r7ikx4ow0ypr" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
<tr><td>FTP server</td><td><input type="text" name="ftpserver" size="25" value="ftp.fedeb.net"> port <input type="text" name="ftpserverport" size="3" value="21"></td></tr>
<tr><td>Username</td><td><input type="text" name="username" size="25" value="brestcam"></td></tr>
...
<tr><td>Installation directory</td><td><input type="text" name="targetdirectory" size="25" value="/www"></td></tr>
</table>
