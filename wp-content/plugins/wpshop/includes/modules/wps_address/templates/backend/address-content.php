...
?>
		<li class="<?php echo $class; ?> wps-bloc-loader wps_address_li">
			...
			<span class="wps-itemList-tools">
				<a href="<?php echo admin_url( 'admin-ajax.php'); ?>?action=wps_order_load_address_edit_form&address_id=<?php echo $address_id; ?>&address_type=<?php echo $address_type_id; ?>&customer_id=<?php echo $customer_id; ?>&width=740&height=690" title="<?php _e( 'Edit this address', 'wpshop' ); ?>" class="wps-address-edit-address  thickbox" id="wps-address-edit-address-<?php echo $address_id; ?>"><i class="wps-icon-pencil"></i></a>
