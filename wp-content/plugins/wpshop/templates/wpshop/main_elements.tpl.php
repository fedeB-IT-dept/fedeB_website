...
ob_start();
?><div class="container_product_listing wps-bloc-loader" ><ul class="products_listing wpshop_clearfix {WPSHOP_PRODUCT_LIST_DISPLAY_TYPE}_mode {WPSHOP_PRODUCT_LIST_DISPLAY_TYPE}_{WPSHOP_PRODUCT_LIST_PER_LINE}" >{WPSHOP_PRODUCT_LIST}</ul></div><?php
